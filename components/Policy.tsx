...
export const Policy = () => {
    ...
    return (
        <div className="inline-block text-sm items-center">
            <Iubenda id={myPolicy}  className="inline-block text-sm items-center" type='privacy' styling='white'>
                <span className="text-sm text-bold inline-block  ">Privacy Policy</span>
            </Iubenda>

            <Iubenda id={myPolicy}  className="inline-block text-sm items-center" type='cookie' styling='white'>
