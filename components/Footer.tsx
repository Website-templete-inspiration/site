                ...
                <div className="w-full flex flex-col md:flex-row mt-4 mb-6 sm:mb-4 ">
                    <div className="mx-auto sm:mx-0 p-3 sm:p-1">
                        <div className="text-sm">
                            <p
                                ...
                                <span className="hover:bg-pink-500 rounded-md px-2 py-1 hover:text-gray-50">&copy; {me.name}</span>
                            </p>
                    ...
                    <div className="space-x-4 flex flex-row mx-auto p-6 sm:p-4 ">
                        <div
                            ...
                            <a href={`mailto:${me.email}`} target="_blank" rel="noreferrer" aria-label="dB Development Mail" className="hover:text-red-700 hover:text-gray-50">
                        ...
                        <Link href={SocialMedia.Medium}>
                            <a target="_blank" rel="noreferrer" aria-label="Medium">
